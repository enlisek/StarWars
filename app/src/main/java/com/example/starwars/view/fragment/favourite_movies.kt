 ...
 * Use the [favourite_movies.newInstance] factory method to
 * create an instance of this fragment.
 */
class favourite_movies : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment favourite_movies.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            favourite_movies().apply {
