...
class LocalPlanetAdapter(var data: LiveData<List<FavPlanet>>, val favouritiesViewModel: FavouritiesViewModel): RecyclerView.Adapter<LocalPlanetAdapter.NoteHolder>() {
